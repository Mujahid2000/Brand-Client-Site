...
const Contact = () => {
    return (
        <div className='flex justify-center dark:bg-gray-900 pb-36'>
            ...
            <div >
            <div className="card dark:bg-gray-900 bg-gradient-to-t from-red-50 to-orange-50 w-96 p-6 bg-base-100 shadow-xl">
            ...
            <div>
            <div className="card dark:bg-gray-900 bg-gradient-to-r from-orange-100 to-red-50 w-96 p-6 bg-base-100 shadow-xl">
            <div className="card-body">
